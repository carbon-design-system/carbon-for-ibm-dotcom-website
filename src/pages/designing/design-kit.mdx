...
**The v2 Beta kit is now available!** The _Carbon for IBM.com v2 Figma library_ is now available to internal users. The library is marked as BETA as we continue to add new components and updates. As we make updates, some components may receive breaking changes due to these enhancements. The previous Carbon for IBM.com libraries will be deprecated one month after the release of the new Beta library. You may need to switch instances of components to the new library to stay current with updates.
