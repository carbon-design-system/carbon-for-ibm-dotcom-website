...
We've been working on a new Sketch kit for delivering pre-built versions of the
Carbon for IBM.com components. We’re releasing the assets iteratively and the
first versions are available below. They include color tokens, expressive and
productive type styles, and key Carbon for IBM.com components. We’ll be adding
more components over time and you will receive notifications for any library
updates within Sketch.
...
[Design Toolbox](https://w3.ibm.com/design/toolbox/#/ui-design-tools/sketch/README).
