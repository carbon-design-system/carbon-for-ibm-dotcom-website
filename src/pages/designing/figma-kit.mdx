...
We have a new Figma kit for delivering Carbon for IBM.com components. The kit contains libraries for each theme and includes components and grid templates. We’ll be adding more components over time, and Figma will notify you when library updates are available.
