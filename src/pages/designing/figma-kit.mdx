...
The Carbon for IBM.com libraries use the type tokens from the [Carbon core libraries](https://carbondesignsystem.com/designing/kits/figma). If you have one or more of the Carbon core libraries active, you can apply those type tokens to your designs. To apply text styles to text:
...
The Carbon for IBM.com libraries use the color tokens from the [Carbon core libraries](https://carbondesignsystem.com/designing/kits/figma). If you have one or more of the Carbon core libraries active, you can apply those type tokens to your designs. To apply text styles to text:
