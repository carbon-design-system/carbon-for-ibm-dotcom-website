...
**Note:** The Expressive Theme has been integrated into Carbon Design System's core library.  This means that expressive continues to be available to IBM.com, but now all Carbon adopters can get both productive and expressive experiences from the same library source. We are shifting to use core library in the next few months, then Expressive Theme will no longer be maintained.
