...
**Icons and color swatches.** The full IBM color pallet lives in the [IBM Design Language library](sketch://add-library/cloud/4f1cbe6c-6626-405e-8c46-a9ae41a30cba). The IBM icons live in the [IBM Icons (16px, 20px) library](sketch://add-library/cloud/KW2yr) and [IBM Icons (24, 32px) library](sketch://add-library/cloud/2bwkM), you can install both icon libraries or just the one that suits your experience needs.
