...
<AnchorLink>Carbon Devtools</AnchorLink>
...
Carbon Devtools can be used to help you validate tokens, and to also check that
the layout is aligned to the grid when going to QA a live, staging, or local
page built by development.
