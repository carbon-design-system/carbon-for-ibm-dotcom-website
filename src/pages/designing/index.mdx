...
We provide a [Design kit](designing/design-kit) that includes assets for the White theme which is primarily used throughout the IBM.com experience. The kit includes color tokens, the expressive and productive type styles, and select components.
