...
* For design guidelines, see the [Designing](https://ibm-dotcom-library.mybluemix.net/get-started/designing) page.
* For coding guidelines, see the [Coding](https://ibm-dotcom-library.mybluemix.net/get-started/coding) page.
