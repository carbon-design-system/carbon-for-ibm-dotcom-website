...
The Expressive Theme has been integrated into Carbon Design System's core library. It simply means that expressive continues to be available to IBM.com, but now all Carbon adopters can get both productive and expressive experiences from the same [source](https://github.com/carbon-design-system/carbon).
...
* For design guidelines, see the [Designing](https://www.ibm.com/standards/web/carbon-for-ibm-dotcom/designing) page.
* For coding guidelines, see the [Coding](https://www.ibm.com/standards/web/carbon-for-ibm-dotcom/developing) page.
