...
- The Carbon Expressive Sketch kit will no longer be maintained. We will be focusing on components unique to IBM.com, and making those design assets more available for adopters.
- For expressive type styles, please use the [Carbon’s Design kit](https://carbondesignsystem.com/designing/kits/sketch/).
