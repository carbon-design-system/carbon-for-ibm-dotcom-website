...
- The Carbon Expressive Sketch kit will no longer be maintained. Please find the expressive component and type styles in [Carbon's Design kit](https://carbondesignsystem.com/designing/kits/sketch/).
...
- If you are using the Expressive theme wrapper independently outside Carbon for IBM.com, please migrate to use Carbon for IBM.com, or Carbon's core library.
