...
The full icon library and full IBM color pallete live in the [IBM Design Language library](https://www.ibm.com/design/language/).
...
The IBM 2x Grid is the framework for laying out all visual elements. You can find the grid template inside of the “IBM Design template” file in Sketch. See the [Grid](#) guideline for a more detailed walkthrough of the 2x Grid.
...
If you’re brand new to Sketch, they offer some great tutorials and help docs.
...
If you experience any issues while getting set up with IBM Digital Design kit, please head over to the [GitHub repo](#) for more guidelines and support. Please [create an issue](#) if your issue does not already exist.

You can also have your questions answered on the [#digital-design-adopters-designers](#) Slack channel.
