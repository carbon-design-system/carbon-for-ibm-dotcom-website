...
## Introduction
The IBM.com Library and IBM.com Library Expressive kits are currently available for Sponsor Adopters only. The Carbon for IBM.com team is in the midst of development and has limited bandwidth to provide support to all IBM teams at this time. We plan to release the kits more broadly once the components are production ready. 
...
For product design, the [Carbon kit](https://www.carbondesignsystem.com/get-started/design/) is available via Sketch Cloud and you do not have to request access to the box folder.

**4. Bring in additional colors and icons.**
The full IBM color pallet lives in the [IBM Design Language library](http://sketch//add-library/cloud/nwqmk). The IBM icons live in the [IBM Icons (16px, 20px) library](http://sketch//add-library/cloud/KW2yr) and [IBM Icons (24, 32px) library](http://sketch//add-library/cloud/2bwkM).
