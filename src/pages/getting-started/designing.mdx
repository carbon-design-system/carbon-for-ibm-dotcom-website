...
## Introduction
The IBM.com Library team is working to adopt the Carbon design system for IBM.com. Please check the [adoption routes](http://ibm-dotcom-library.mybluemix.net/getting-started#how-to-decide-the-right-path-for-adoption) and discuss with your team before adopting the IBM.com Library.  
