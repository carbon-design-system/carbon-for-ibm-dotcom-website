...
## Introduction
The IBM.com Library team is working to adopt the Carbon design system for IBM.com. We recommend checking with your team before adopting the IBM.com Library, if you're not ready to adopt the Carbon codebase check out our [adoption routes](http://ibm-dotcom-library.mybluemix.net/getting-started/#various-paths-for-the-adoption-of-carbon-across-ibm.com). 

The IBM.com Library includes:
* Expressive type styles
* IBM.com specific components (eg masthead and footer)

We utilize the Carbon design system for core components, such as:
* buttons
* checkboxes
* etc
