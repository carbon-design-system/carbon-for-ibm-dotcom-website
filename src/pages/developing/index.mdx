...
**Note:** The [@carbon/ibmdotcom-react](https://www.npmjs.com/package/@carbon/ibmdotcom-react) package will be deprecated in Carbon for IBM.com V2. This package will fall into maintaince-mode, with updates only for potential security issues and high severity bugs. For an estimated timeline on the V2 release, you can view the Carbon for IBM.com [roadmap](https://app.zenhub.com/workspaces/carbon-for-ibmcom-5d449f3642eb1962336cbe52/roadmap). In Carbon for IBM.com V2, [@carbon/ibmdotcom-web-components](https://www.npmjs.com/package/@carbon/ibmdotcom-web-components) will be the main package moving forward. Applications using React can use the [react-wrapper](/developing/frameworks/react-wrapper) components supported by the the Carbon for IBM.com Web Components package.
