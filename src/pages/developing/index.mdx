...
Carbon for IBM.com is available in <Link to="/developing/frameworks/web-components">web components</Link>, or <Link to="/developing/frameworks/react-wrapper">web component: React wrappers</Link>. Choosing a framework would depend on the needs of your application.
