...
[IBM Digital Badge](). These badges are available to anybody who completes the
...
React badge, see the [Acclaim](https://www.youracclaim.com/org/ibm/badge/tbd)
site.
...
1. Complete steps 1 through 5 of the Carbon for IBM.com Web Components tutorial:
   ...
   - Step 2. [TBD](/developing/web-components-tutorial/step-2)
   - Step 3. [TBD](/developing/web-components-tutorial/step-3)
   - Step 4. [TBD](/developing/web-components-tutorial/step-4)
   - Step 5. [TBD](/developing/web-components-tutorial/step-5)
...
3. Apply for the IBM Digital Badge by completing the [form and survey]().
...
To apply for the IBM Digital Badge, please complete the [form and survey]().
