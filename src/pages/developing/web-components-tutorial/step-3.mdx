...
<AnchorLink>Add Content block with Content group and Content items</AnchorLink>
...
A [preview](https://carbon-design-system.github.io/carbon-for-ibm-dotcom-tutorial/step-4/) of what you'll build:
...
## Add Content block with Content group and Content items
...
Now, add the anchor element for the `Table of contents` and a `Content section` with a `Content block` and `Content group` within. The following should appear
...
use the `footer` slot and add the following:
