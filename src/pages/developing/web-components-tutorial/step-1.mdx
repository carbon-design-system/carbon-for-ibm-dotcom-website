...
```bash
yarn add @carbon/ibmdotcom-web-components@1.16.1
```
...
```bash
yarn add carbon-web-components@1.21.0 carbon-components@10.55.0 @carbon/type@10.43.1 @carbon/grid@10.43.0 @carbon/themes@10.53.1
```
...
```scss path=src/assets/scss/app.scss
@import 'carbon-components/scss/globals/scss/css--reset';
@import '@carbon/type/scss/font-face/mono';
@import '@carbon/type/scss/font-face/sans';
@import '@carbon/grid/scss/grid';
...
**Note:** If you check Git Actions against the recent commit on your forked instance and notice that the "Build GH Pages" action is failing, this is expected if you have only copied over the `main` branch when forking your repository. This should not affect the status checks when you open your pull request, so feel free to ignore.
