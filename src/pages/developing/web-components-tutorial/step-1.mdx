...
<Link to="/components/footer">footer</Link> to the page, there are more steps necessary to properly configure those
components in order to load in the proper language and locale translation files, as well as the available translation
