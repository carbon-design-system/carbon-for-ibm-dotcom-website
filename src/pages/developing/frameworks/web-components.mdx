...
Here are examples on setting by tag:
...
```html
<script type="module" src="https://1.www.s81c.com/common/carbon-for-ibm-dotcom/version/v1.6.0/dotcom-shell.rtl.min.js"></script>
```

Check [npmjs.com](https://www.npmjs.com/package/@carbon/ibmdotcom-web-components) to see what is the latest available version.
...
<!-- LATEST tag -->
<script type="module" src="https://1.www.s81c.com/common/carbon-for-ibm-dotcom/tag/v1/latest/dotcom-shell.rtl.min.js"></script>

<!-- NEXT tag -->
<script type="module" src="https://1.www.s81c.com/common/carbon-for-ibm-dotcom/tag/v1/next/dotcom-shell.rtl.min.js"></script>

<!-- BETA tag -->
<script type="module" src="https://1.www.s81c.com/common/carbon-for-ibm-dotcom/tag/v1/beta/dotcom-shell.rtl.min.js"></script>
```
...
```
<br/>
<Link to="/developing/carbon-cdn-style-helpers">Learn more about Carbon CDN style helpers</Link>
