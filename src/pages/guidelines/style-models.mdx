...
<Caption>
  The footer for the Editorial model on IBM.com.
</Caption>
...
![The Product and docs model in context in an IBM product screen.](../../images/guidelines/style-models/product_style_model_03.png)

<Caption>The Product and docs model in context in an IBM product screen.</Caption>
...
<Caption>The High-density interface model in context in the IBM Cloud catalog.</Caption>
