...
**High density interface**<br/> Full width, grid stretches
...
Begin designing by parsing through the content for hierarchies, and start with the most essential, overarching concepts at the top, then add the main details of the subject matter, and finally, position the related or supportive content at the bottom. Try to consider the mobile layout first because it forces us to be disciplined in sequencing content in a logical order.

Refer to the Layout page in our Guidelines section for more guidance on [Content hierarchy](/guidelines/layout#content-hierarchy).
...
At IBM.com, we have not yet encountered this use case. If your content fits this category, and is not external facing, consider using <a href="https://carbondesignsystem.com/" target="_blank">Carbon Design System</a>.
...
If you are using Carbon Design System, refer to their existing guidance on <a href="https://carbondesignsystem.com/guidelines/2x-grid/overview/#screen-regions" target="_blank">screen regions</a>.
