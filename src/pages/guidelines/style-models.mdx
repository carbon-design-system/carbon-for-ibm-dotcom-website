...
![The Product in context in an IBM product screen.](../../images/guidelines/style-models/product_style_model_03.png)

<Caption>The Product in context in an IBM product screen.</Caption>
