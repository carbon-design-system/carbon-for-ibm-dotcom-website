...
Grid should also be centered when the screen width is larger than max width to present content front and center.
...
<Row>
<Column colMd={4} colLg={4} >
<DoDontExample type="do" caption="For dashboards or data visualizations, utilize the full screen width to present as much information as possible.">
...
Documentation sites deal with large volumns of text and media content. It benefit from a persistant navigation to help with organization and way finding.

Left aligning grid to allow the navigation to stick to one side of the screen.

<Row>
<Column colMd={4} colLg={4} >
<DoDontExample type="do" caption="Documentation benefits from a persistant navigation and a controlled max width.">

![Editorial model uses max width](../../images/guidelines/style-models/style-models-docu-1.png)
