...
The primary user intent drives the foundational structure of any given page&mdash;the style models. This ensures consistency. These are the known user intents and associated style models for IBM.com pages.
...
| [&#x21b3;&nbsp;Overview (dashaboard)](#overview) | The user needs to have an overview of a given context or system and identify action items or priority items. |
...
The **editorial navigation style model** is usually used on navigagtional pages that have additional content pieces or provide highly curated sections such as featured products.
...
Similar to the index navvigation style model, the **listing style model** focuses mainly on navigation in a vertical list style.
...
The **overview style model** is commonly used in creating dashboard or similar experences.
...
This style model is optimal for long-form-reading pages such as blogs, news articles, and learn pages.
