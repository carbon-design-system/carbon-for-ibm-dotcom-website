...
The primary user intent drives the foundational structure of any given page. This ensures consistency. These are the known user intents and associated style models for IBM.com pages.
