...
<Row>
<Column colMd={4} colLg={4} >
  <DoDontExample type="do" caption="Different components can use the same 2x grid. When stacked, the result is a consistent rhythm and visual alignment between each pattern.">

![Different components can use the same 2x grid. When stacked, the result is a consistent rhythm and visual alignment between each pattern.](../../images/pattern/overview/patterns_overview_2xgrid_section2_do.jpg)
...
This _content block with media_ component shows how various elements can be designed and organized based on their priority and relevance. In this example, type scale, image size, negative space, and UI component usage all play an important role in defining the content hierarchy.
...
<Caption>
 In this component, groups of related content and spacial affordances improves the scannability and ease of navigation across the layout.
 </Caption>
...
This _content group_ component demonstrates how typography of different scales, weight and color can be used to create visual hierarchy.
...
The _lead space_ component shows how the use of scale and juxtaposition of type and image can be used to emphasize messaging and create clear calls-to-action.
...
These _cards – with images_ component utilizes asymmetry to arrange essential content in a single area.

## Creating pages with layout components

Layout components, when combined together in a particular way, can be used to form many different page types across ibm.com. Some of the most common page types include editorial, navigational, and transactional. When designing or adopting a layout component, it is important to consider the purpose of both the content and the purpose of the page where the pattern will be displayed. 
...
![When stacked, components with a consistent grid structure but diverse layout and content types can create a dynamic and engaging page-level experience](../../images/pattern/overview/patterns_overview_Repetition_section1_do.png)
...
<Caption>
 ...
 Using the same layout component for similar touch-points across multiple pages can provide a sense of continuity and familiarity for the user. 
...
Reflect on the following statements as you start to design and adopt layout components. Use these to guide your understanding, decision making and application of pattern best practices.
