...
<Caption>
  This <i>Content block media</i> component shows how various elements can
  be designed and organized based on their priority and relevance. In this
  example, type scale, image size, negative space, and UI component usage all
  play an important role in defining the content hierarchy.
</Caption>
