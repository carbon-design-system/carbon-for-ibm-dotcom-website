...
<Caption>
This <i>content block with media<i> component shows how various elements can be designed and organized based on their priority and relevance. In this example, type scale, image size, negative space, and UI component usage all play an important role in defining the content hierarchy.
 </Caption>
...
<Caption>
  This <i>content group<i> component demonstrates how typography of different scales, weight and color can be used to create visual hierarchy.
 </Caption>
...
<Caption>
  The <i>Lead space<i> component shows how the use of scale and juxtaposition of type and image can be used to emphasize messaging and create clear calls-to-action.
 </Caption>
...
<Caption>
  These <i>Cards – with images<i> component utilizes asymmetry to arrange essential content in a single area.
 </Caption>
