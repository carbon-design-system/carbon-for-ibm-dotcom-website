...
We've created detailed usage guidance for working with the productive and expressive type sets, explaining and illustrating where blending of the type sets can enhance experiences. Learn more on the [Type strategies](/expressive-styling/type-strategies) tab. 
...
As mentioned above, this current approach is changing soon. We will provide more details and ensure your transition is seamless.
