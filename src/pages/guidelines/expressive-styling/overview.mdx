...
Expressive styling is used primarily for web pages and productive styling is used primarily for products. It's important to understand the differences between the two stylistic expressions so that you can make informed choices when you encounter the different styles. See [Styling strategies](../expressive-styling/styling-strategies) to learn how to choose a style. 
