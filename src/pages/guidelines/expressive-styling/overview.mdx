...
The Carbon for IBM.com and Carbon teams are currently working to consolidate assets into the one core library. 

- *The Carbon Sketch kit* will contain expressive styling. What was previously known as the Expressive Theme has been integrated into the core library, and the Expressive Theme Sketch kit is no longer being maintained.
...
- *The type token names* will be updated for ease of understanding and use within the Carbon v11 release.

- *The Sketch kit flyout menus* for type styles is being redesigned to accommodate expressive styling and to help with decision making.

- *A Carbon for IBM.com Sketch kit* with IBM web page components is also in the works. 
...
We've created detailed usage guidance for working with the productive and expressive type sets, explaining and illustrating where blending of the type sets can enhance experiences. Learn more on the [Type usage](/expressive-styling/type-usage) tab. 
