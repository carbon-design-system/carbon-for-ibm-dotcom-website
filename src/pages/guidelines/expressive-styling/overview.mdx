...
Expressive styling is used primarily for web pages and productive styling is used primarily for products. It's important to understand the differences between the two stylistic expressions so that you can make informed choices when you encounter the different styles.
...
Within **Body styles** and **Supporting styles**, the same set of styles are offered. Productive styles are named with a suffix of `-01` and expressive style names have a suffix of `-02`. As you can see in the following image, the line heights increase to accommodate the larger expressive type sizes. 
...
<Caption>Comparison of naming conventions and different line heights for expressive and productive styles</Caption>
...
<Caption>Comparison of link, list, and button in productive and expressive stylings</Caption>
