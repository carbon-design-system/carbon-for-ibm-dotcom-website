...
When you need to open links in a new window, make sure you use text and a launch icon but never just the icon itself to indicate that a new browser window will open.
...
When you need to open links in a new window, always keep accessibility in mind and make sure the screen reader can precisely tell the link.
...
When you need to warn the users, the link will take them off the IBM website; you may use the Leaving IBM notice. The Leaving IBM notice displays as an overlay, and you can learn more on the [Leaving IBM page](https://www.ibm.com/standards/web/carbon-for-ibm-dotcom/components/leaving-ibm) on the Carbon for IBM.com website.

IBM websites must not link to any non-IBM site that does not have a privacy policy that is prominently posted. If no policy is posted, you must consult IBM General Legal counsel.
