...
For any given page, there is an overarching user intent—we call this the primary user intent of a page. For example, learn is the primary user intent for an early learn search capture page.
