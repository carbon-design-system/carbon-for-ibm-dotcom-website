...
These are the known user intents and associated style models for IBM.com pages.
...
| [&#x21b3;&nbsp;Listing](#listing) | The user wants to find the destination by quick scanning a list of available options. |
