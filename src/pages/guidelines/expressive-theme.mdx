...
According to the various research, 16px (12 points) was chosen as the common base type size for all device form factors for the web and IBM.com experiences with a focus on readability and accessibility.
