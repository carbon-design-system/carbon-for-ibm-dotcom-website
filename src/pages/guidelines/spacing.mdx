...
When designing for IBM.com, the spacing scale and type tokens are used to ensure the information is well organized and consistent. See the [Type pairing guidance](../expressive-styling/type-pairing) to learn more about the type hierarchy of the Carbon for IBM.com components.
...
Yes, please see [Expressive styling](../../expressive-styling/type-pairing) to learn more about styling strategies and type pairings.
