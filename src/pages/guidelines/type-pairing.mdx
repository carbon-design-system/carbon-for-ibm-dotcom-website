...
Content section pairs `$heading-02` and `$body-02` with no space between the two type styles. For details about top and bottom spacing, see the spacing table below.
...
Content block pairs `$fluid-heading-05` and `$fluid-heading-03` with 32px of space between the two type styles. For details about top and bottom spacing, see the spacing table below.
...
See the fluid headings at different breakpoints on Carbon's [type set details](https://www.carbondesignsystem.com/guidelines/typography/type-sets) page. 
...
Content group pairs `$fluid-heading-04` and `$body-02` with 32px of space between the two type styles. For details about top and bottom spacing, see the spacing table below.
...
Content item pairs `$heading-02` and `$body-02` with no space between the two type styles. For details about top and bottom spacing, see the spacing table below.
