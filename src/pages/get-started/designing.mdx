...
<Row className="resource-card-group">
  <Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      ...
      href="https://github.com/carbon-design-system/carbon-for-ibm-dotcom-design-kit/issues/new?assignees=ljcarot%2C+wonilsuhibm%2C+oliviaflory&labels=adopter+support&template=request-access.md&title=Design+kit+access+request"
    >
...
From the Insert menu, select `Symbols → Carbon for IBM.com` to add symbols onto your page.

Carbon for IBM.com symbols are built to be flexible, and designers should not detach symbols from the library. Once a symbol is detached, you will no longer receive updates as they are released.
...
#### Library menu navigation 
From the main menu select `Insert → Text Styles → IBM.com` to insert a Carbon for IBM.com text style.
...
* The first layer is the theme selection (i.e. Carbon for IBM.com (White theme)). 
* The second layer is core Carbon for IBM.com color tokens (i.e., field-01) for the selected them.
