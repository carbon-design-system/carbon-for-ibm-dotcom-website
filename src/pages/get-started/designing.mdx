...
**1. Install Sketch.**
To design with the Carbon for IBM.com kit and Carbon Expreessive kit you must have the most recent version of [Sketch](https://www.sketch.com) installed.
...
To add the libraries, from Sketch navigate to `Preferences → Libraries → Add Library` and select `Box → Digital design → IBM Design kit → Carbon for IBM.com → Carbon Expressive (White theme)`.
