...
| **Vanilla**<br/>([`@carbon/ibmdotcom-vanilla`](https://github.com/carbon-design-system/carbon-for-ibm-dotcom/blob/master/packages/vanilla))                      | IBM.com Vanilla components (deprecated)                                     | &ndash;&nbsp;&nbsp;Latest Carbon<br/>&ndash;&nbsp;&nbsp;Services<br/>&ndash;&nbsp;&nbsp;Utilities<br/><br/><em>NOTE: Styles will need to be included separately</em>  |
