...
In-page navigation is used to intentionally move users through a narrative in a logical manner or allow them to choose their own journey. 
...
## Overview
In-page navigation allows a user to skip to or reveal content that is located on a single page at any point, without leaving that page. 
