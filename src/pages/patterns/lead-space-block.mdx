...
This pattern includes a headline, subheadline, supporting message, [Link list](https://ibmdotcom-react.mybluemix.net/?path=/story/components-linklist--default) and a call to action. There is also the option to add media in the form of an image or video.
