...
| --------      | -----------------------     | ----------  | ---------- |
| Left-aligned  | `$expressive-heading-06` <br/>`$display-01` | This is the most commonly used Lead space style. The left-aligned type draws the users' attention to the Lead space messaging immediately. Used in marketing and product pages, among others.  | Stable, New |
...
| Background image  | Yes<br/>Note: each breakpoint requires a different image scaled to the following sizes:<br/><ul class="bx--list--unordered bx--list--nested"><li>mobile: 320 X 370</li><li>tablet: 672 X 400</li><li>desktop: 1056 X 480</li></ul>     |    |
...
![$expressive-heading-06 mobile display](../../images/pattern/leadspace/LeadSpace_Mobile _Heading_06.png)
