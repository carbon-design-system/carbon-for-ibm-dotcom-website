...
| ------------- | -----------   | ------------------------------------------------------------------------             |
| React         | <div><span class="bx--tag bx--tag--teal"><pre>Experimental</pre></span></div>        | [View sandbox](https://ibmdotcom-patterns-react-experimental.netlify.com/?path=/story/leadspace--default-with-image)   |
...
| --------      | -----------------------     | ----------  | ---------- |
| Left-aligned  | `$expressive-heading-06` <br/> `$display-01` | This is the most commonly used Lead space style. The left-aligned type draws the users' attention to the Lead space messaging immediately. Used in marketing and product pages, among others.  | <div><span class="bx--tag bx--tag--green"><pre>Stable</pre></span></div> <span class="bx--tag bx--tag--purple"><pre>New</pre></span> |
| Centered      | `$expressive-heading-05`  | This option has 4 empty columns on the left and right to accommodate pages that have content positioned in the center of the 16-column grid. Used in the upcoming Learn page template and other long-form reading experiences.  | <span class="bx--tag bx--tag--cool-gray"><pre>Under construction</pre></span> |
