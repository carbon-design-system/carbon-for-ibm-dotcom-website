...
| ------------- | -----------   | ------------------------------------------------------------------------             |
| React         | <div><span class="bx--tag bx--tag--teal"><pre>Experimental</pre></span></div>        | [View sandbox](https://ibmdotcom-patterns-react-experimental.mybluemix.net/?path=/story/leadspace--default-with-image)   |
