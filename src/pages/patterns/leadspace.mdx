...
| --------      | -----------------------     | ----------  | ---------- |
| Left-aligned  | <span class="bx--tag bx--tag--blue"><pre>$expressive-heading-06</pre></span><span class="bx--tag bx--tag--blue"><pre>$display-01</pre></span> | This is the most commonly used Lead space style. The left-aligned type draws the users' attention to the Lead space messaging immediately. Used in marketing and product pages, among others.  | Stable, New |
| Centered      | <span class="bx--tag bx--tag--blue"><pre>$expressive-heading-05</pre></span>  | This option has 4 empty columns on the left and right to accommodate pages that have content positioned in the center of the 16-column grid. Used in the upcoming Learn page template and other long-form reading experiences.  | Coming soon |
