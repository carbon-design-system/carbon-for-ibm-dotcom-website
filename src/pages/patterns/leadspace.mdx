...
| Centered      | `$expressive-heading-05`  | This option has 4 empty columns on the left and right to accommodate pages that have content positioned in the center of the 16-column grid. Used in the upcoming Learn page template and other long-form reading experiences.  | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span> |
