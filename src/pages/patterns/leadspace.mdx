...
| Background image  | Yes<br/> <br/>_Note: each breakpoint requires a<br/>different image scaled<br/>to the following sizes:_<br/><ul class="bx--list--unordered bx--list--nested"><li>mobile: 320 X 370</li><li>tablet: 672 X 400</li><li>desktop: 1056 X 480</li></ul>     |    |
