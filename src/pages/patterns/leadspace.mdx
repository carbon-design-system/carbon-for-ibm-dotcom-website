...
| --------      | -----------------------     | ----------  | ---------- |
| Left-aligned  | <div><span class="bx--tag bx--tag--blue"><pre>$expressive-heading-06</pre></span></div> <div><span class="bx--tag bx--tag--blue"><pre>$display-01</pre></span></div> | This is the most commonly used Lead space style. The left-aligned type draws the users' attention to the Lead space messaging immediately. Used in marketing and product pages, among others.  | <div><span class="bx--tag bx--tag--green"><pre>Stable</pre></span></div> <div><span class="bx--tag bx--tag--teal"><pre>New</pre></span></div> |
