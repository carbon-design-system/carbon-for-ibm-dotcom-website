...
| ------------- | -----------   | ------------------------------------------------------------------------             |
| React         | <div><span class="bx--tag bx--tag--green"><pre>Stable</pre></span></div>        | [View sandbox](https://ibmdotcom-patterns-react-experimental.netlify.com/?path=/story/leadspace--default-with-image)   |
| Vanilla       | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span>   |                                                                                      |
...
| --------      | -----------------------     | ----------  | ---------- |
| Left-aligned  | `$expressive-heading-06` <br/> `$display-01` | This is the most commonly used Lead space style. The left-aligned type draws the users' attention to the Lead space messaging immediately. Used in marketing and product pages, among others.  | <div><span class="bx--tag bx--tag--green"><pre>Stable</pre></span></div> <div><span class="bx--tag bx--tag--teal"><pre>New</pre></span></div> |
| Centered      | <span class="bx--tag bx--tag--blue"><pre>$expressive-heading-05</pre></span>  | This option has 4 empty columns on the left and right to accommodate pages that have content positioned in the center of the 16-column grid. Used in the upcoming Learn page template and other long-form reading experiences.  | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span> |
...
1. **Background image:** <br/>
    *optional
    <ul class="bx--list--unordered">
        <li>width: 100% of container for all breakpoints</li>
        <li>size:
            <ul class="bx--list--unordered bx--list--nested">
                <li>mobile: 320 X 370</li>
                <li>tablet: 672 X 400</li>
                <li>desktop: 1056 X 480</li>
            </ul>
        </li>
    </ul>
