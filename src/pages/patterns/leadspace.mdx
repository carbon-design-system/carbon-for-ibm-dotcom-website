...
| --------      | -----------------------     | ----------  | ---------- |
| left-aligned  | `$expressive-heading-06`
`$display-01`                     | This is the most commonly used Lead space style. The left-aligned type draws the users' attention to the Lead space messaging immediately. Used in marketing and product pages, among others.  | Stable, New |
| centered      | `$expressive-heading-05`  | This option has 4 empty columns on the left and right to accommodate pages that have content positioned in the center of the 16-column grid. 
Used in the upcoming Learn page template and other long-form reading experiences.   | Under construction |
...
![The background image should never interfere with the text or call to action buttons.](../../images/patterns/leadspace/)
...
![Use a gradient overlay to ensure maximum readability of text.](../../images/patterns/leadspace/)
...
![Never place primary CTA on the left when using two buttons.](../../images/patterns/leadspace/)
...
![Always place primary CTA on the right or at the bottom when stacking.](../../images/patterns/leadspace/)
...
![Never use sentences for CTAs. ](../../images/patterns/leadspace/)
...
![CTA copy should be informative but brief.](../../images/patterns/leadspace/)
...
![Dark theme](../../images/patterns/leadspace/)
<Caption>Dark</Caption>

![Light theme](../../images/patterns/leadspace/)
