---
title: Lead space
description: Lead space is positioned at the top of a web page and serves as the first site of viewer engagement; its primary purpose is to orient the user when they land on a page and to help them decide whether to continue reading or not as well as orient themselves.
---

<PageDescription>


Lead space is positioned at the top of a web page and serves as the first site of viewer engagement. Its primary purpose is to orient the user when they land on a page, inform them of the content, and guide them to the first key piece of content on the page, whether it's a crucial piece of information or a call-to-action button.
...
| -------- | ----------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| React    | <div><span class="bx--tag bx--tag--teal"><pre>Experimental</pre></span></div> | [View storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-leadspace--default-with-no-image) |
| Vanilla  | <span class="bx--tag bx--tag--cool-gray"><pre>Under construction</pre></span> |                                                                                                                  |

## Anatomy

![Anatomy of the lead space](../../images/pattern/leadspace/LeadSpace_Left_Heading06_Anatomy.jpg)
...
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Headline                 | Yes                                                                                                                                                                                                                                                                                                                                                       | XS <div>&nbsp;&nbsp;&nbsp;&ndash;&nbsp;&nbsp;65 English</div><br /><div>&nbsp;&nbsp;&nbsp;&ndash;&nbsp;&nbsp;85 Translation</div>   |
| Short copy               | No                                                                                                                                                                                                                                                                                                                                                        | M <div>&nbsp;&nbsp;&nbsp;&ndash;&nbsp;&nbsp;120 English</div><br /><div>&nbsp;&nbsp;&nbsp;&ndash;&nbsp;&nbsp;150 Translation</div>  |
| Secondary call to action | No                                                                                                                                                                                                                                                                                                                                                        | M <div>&nbsp;&nbsp;&nbsp;&ndash;&nbsp;&nbsp;120 English</div><br /><div>&nbsp;&nbsp;&nbsp;&ndash;&nbsp;&nbsp;150 Translation</div>  |
| Primary call to action   | No                                                                                                                                                                                                                                                                                                                                                        | XXS                                                                                                                                 |
| Background image         | Yes<br/> <br/><div style="max-width: 200px">_Note: each breakpoint requires a different image scaled to the following sizes:_</div><br/><div>&nbsp;&nbsp;&nbsp;&ndash;&nbsp;&nbsp;mobile: 320 X 370</div><br /><div>&nbsp;&nbsp;&nbsp;&ndash;&nbsp;&nbsp;tablet: 672 X 400</div><br /><div>&nbsp;&nbsp;&nbsp;&ndash;&nbsp;&nbsp;desktop: 1056 X 480</div> |                                                                                                                                     |
...
<Caption>
  $display-01 can be used to celebrate strong, editorial messaging. This option
  is most effective when there is no call to action.
</Caption>
