...
**1. Heading:** _type:_ $expressive-heading-06, _color:_ $text-01, _width:_ 95% of container (8 columns)
**2. Content spacer:** Minimum space between lead space heading and short copy: 96px
**3. Short copy:** *optional, type: $expressive-heading-03, color: $text-01, width: 95% of container (4 columns)
**4. Button group:** Use the button group component
**5. Gradient stop:** color: black (#000000), opacity: 75%, linear: left to right, width: 50% of total container width
**6. Background image:** *optional, width: 100% of container for all breakpoints, size: mobile: 320 X 370 tablet: 672 X 400 desktop: 1056 X 480
