...
| ------------- | -----------   | ------------------------------------------------------------------------             |
| React         | <div><span class="bx--tag bx--tag--teal"><pre>Experimental</pre></span></div>        | [View storybook](https://ibmdotcom-patterns-react-experimental.mybluemix.net/?path=/story/leadspace--default-with-image)   |
