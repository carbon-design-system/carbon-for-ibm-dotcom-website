...
[Feature card](../components/card#feature-card) can be used at the end of related content to provide a stronger call to action for users to navigate to an important next step. Feature card comes in two sizes: large and medium.
