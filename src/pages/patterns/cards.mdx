...
Cards can be used as a call-to-action (CTA) to direct users to a key piece of content. A CTA card behaves much like a button or text link but is more prominent in size and descriptive in content.
...
<Caption>
These cards are used as navigational components with each one leading to a unique industry page.
</Caption>
...
Less common but also effective, this option works best on single large cards such as the Feature card. 
...
* [Content group — with cards](./components/contentgroupcards)
