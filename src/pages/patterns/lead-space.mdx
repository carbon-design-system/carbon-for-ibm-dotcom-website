...
#### Regular
The regular Lead space size height is 480 px and it’s used but not limited to the gateway page and detail page.

#### Short
The short Lead space size height is 320 px and it’s used but not limited to the detail page and post-purchase page.

#### Mini
The mini Lead space size height is X px and ....
