...
| Tall | 560px | High level and messaging centric pages |
...
Lead space centered does not have fixed heights. It is ideal for objective statements, such as academic research titles, and problem solving clues, such as “*Find a product*” or “*Let's troubleshoot*”. If you want to transmit a more marketing-oriented message, please use the left-aligned lead space option.
