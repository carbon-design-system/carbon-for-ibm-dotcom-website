...
The curated Lead Space size standards are super, tall, regular, short, mini. please start by using the sizes listed here so we can create consistency for the IBM.com experience.
