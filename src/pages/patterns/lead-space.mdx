...
The size of a left-align lead space height usually reflects the intent of the page and sets the right expectation for the user. Choose from these heights for the different purposes and use cases. To check out more on Lead space heights, see the Lead space component pages linked [below](#related-components-and-patterns).

| Height | Recommended usage |
| :--- | :--- |
| Super – 640px | Brand or immersive experience centric pages |
| Tall – 560px | Marketing oriented pages |
| Medium – 480px | Functional or navigational pages |
| Short – 320px | Minimal lead space with simple title |

### Lead space centered

Lead space centered does not have fixed height variants and it is oriented more towards resolving functional and practical problems. If you want to transmit a more marketing-oriented message, please use the left-aligned lead space option.
