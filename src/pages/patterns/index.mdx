...
<Row>
<Column colMd={6} colLg={8} >
  <DoDontExample caption="When there is no consistent visual flow, spacial model or alignment of content from pattern to pattern and from page to page, the overall experience becomes fragmented and disconnected.">
