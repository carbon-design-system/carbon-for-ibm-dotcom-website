...
**Note:** The following guidelines and layout patterns have been created for DGC squads and approved innovators. Coming soon, Drupal templates with preconfigured layout patterns will be available for all creators of ibm.com pages to use.
