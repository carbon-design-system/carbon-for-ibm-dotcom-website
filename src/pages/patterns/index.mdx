...
| ------------- | -----------   | ----- |
| [CTA section](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-sections-ctasection--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Card section images](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-sections-cardsectionimages--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Card section simple](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-sections-cardsectionsimple--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Lead space](https://ibm-dotcom-library.mybluemix.net/patterns/leadspace)      | The lead space is positioned at the top of a web page. Its primary purpose is to orient the user when they land on a page and to help them decide whether to continue reading or not as well as orient themselves.  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Call out quote](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-calloutquote--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Call out with media](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-calloutwithmedia--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content block](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-sub-patterns-contentblock--default)      | The content block can accommodate multiple levels and types of content including long-form text, image and video. Content block can include many other layout patterns. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content block cards](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-contentblockcards--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content block media](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-contentblockmedia--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content block mixed](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-contentblockmixed--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content block segmented](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-contentblocksegmented--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content block simple](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-contentblocksimple--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content group cards](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-contentgroupcards--default)      | Coming soon.  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content group horizontal](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-contentgrouphorizontal--default)      | Coming soon.  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content group pictograms](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-contentgrouppictograms--default)      | Coming soon.  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content group simple](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-contentgroupsimple--default)      | Coming soon.  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Feature card block large](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-featurecardblocklarge--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Feature card block medium](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-featurecardblockmedium--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Lead space block](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-leadspaceblock--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Logo grid](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-logogrid--default)      | Coming soon. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
