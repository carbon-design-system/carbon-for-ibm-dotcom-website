...
| Name              | Status                                                                                                             |
 | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| Array with cards     | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span> |
| Array with pictograms | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span> |
| [Lead space – left-aligned](/patterns/leadspace) | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Lead space – centered](/patterns/leadspace) | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span> |
...
| Simple long-form | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span> |
| Simple overview | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span> |
| Testimonials | <span class="bx--tag bx--tag--cool-gray"><pre>Under construction</pre></span> |
| Use cases | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span> |
