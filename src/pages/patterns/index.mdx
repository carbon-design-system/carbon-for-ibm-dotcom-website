...
| ------------- | -----------   | ----- |
| [Card section](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-sections-cardsection--default)      | The card section displays a group of cards that relate to the same category, theme or topic. Each card expresses content about a specific subject and can link to a different destination. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
...
| [Content group](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-sub-patterns-contentgroup--default)      | The content group is used to organize related items into short content pieces.  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Feature card](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-featurecard--default)      | The feature card allows a reader to progress to a deeper level of information or associated content. It can be used to indicate significant progression or highlight an important next step. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
...
| [Table of contents](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-sub-patterns-table-of-contents--manually-define-menu-items)      | The table of contents allows users to quickly navigate through long pages by providing jump links to different sections of the content within a single page. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
