...
<Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      subTitle="IBM.com Library Patterns Storybook (React / experimental)"
      aspectRatio="2:1"
...
| Logo grid | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span> |
| Rich overview | <span class="bx--tag bx--tag--cool-gray"><pre>Under construction</pre></span> |
| Simple array | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span> |
| Simple benefits | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span> |
