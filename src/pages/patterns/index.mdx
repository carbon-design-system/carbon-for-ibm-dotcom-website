...
<Caption>In this pattern, groups of related content and spacial affordances improves the scannability and ease of navigation across the layout.</Caption>
...
<Caption>The lead space pattern shows how the use of scale and juxtaposition of type and image can be used to emphasize messaging and create clear calls-to-action. </Caption>
...
<Caption>These cards – with images pattern utilizes asymmetry to arrange essential content in a single area. </Caption>
...
![Repetition, continuity and consistency](../../images/pattern/overview/patterns_overview_Repetition_section1_do.png)

  </DoDontExample>
</Column>  
<Column colMd={4} colLg={4}>
  <DoDontExample caption="">

![Repetition, continuity and consistency](../../images/pattern/overview/patterns_overview_Repetition_section1_don't.png)
...
1. When stacked, patterns with a consistent grid structure but diverse layout and content types can create a dynamic and engaging page-level experience.
1. When the same pattern is repeated multiple times, the user experience becomes restricted and the layout visually uninteresting.
