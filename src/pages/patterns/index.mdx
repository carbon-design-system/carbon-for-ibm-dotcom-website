...
| ------------- | -----------   | ----- |
| [Callout &mdash; quote](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/callout-quote)      | The Callout — quote is a typographic pattern that is used to highlight an impactful client statement or user testimonial. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Callout &mdash; with media](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/callout-with-media)      | The Callout &mdash; with media pattern is used to feature a high value media asset such as a customer story.  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Card section &mdash; with images](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/card-section) | The Card section — with images pattern is a collection of card components with images that, together, occupy a full-width section with a left-column header. This pattern is typically used for presenting resources or links. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Card section &mdash; simple](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/card-section)      | The Card section — simple pattern is a collection of text-based cards presented in a full-width section with a left-column header. This pattern is typically used for presenting resources or links. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content block &mdash; with cards](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/content-block-cards)      | The Content block – with cards pattern is used to present small self-contained pieces of information as cards. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content block &mdash; with media](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/content-block-media)      | The Content block – with media pattern is used to present information with images in a group setting.  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Content block &mdash; segmented      | The Content block – segmented pattern is a variation of the Content block simple pattern with the added ability to add subsections. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content block &mdash; simple](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/content-block-simple)      | The Content block — simple pattern is typically used for the introductory section on a page. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content group &mdash; with cards](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/contentgroupcards)      | The Content group — with cards pattern is used to present information through a group of cards with each acting as a call to action that drives to additional or supporting destinations. This pattern is suitable for adding concise buckets of content and links to a long-form reading experience.  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content group &mdash; horizontal](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/content-group-horizontal) | The Content group – horizontal pattern is to present a group of relatively more important pieces of content such as products or solutions with more visual weight.  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content group &mdash; with pictograms](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/content-group-pictograms) | The Content group — with pictograms pattern is to present a group of information, each with a supporting pictogram. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Content group &mdash; simple](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/content-group-simple) | The Content group — simple pattern is an alternative form of a narrative pattern where the content is broken up into smaller pieces to make it more digestible.  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [CTA Section](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/cta-section)      | The CTA section pattern is used to communicate actions that users can take along with some information that is relevant to the actions. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Feature card block &mdash; large](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/feature-card-block) | The Feature card block — large pattern is used to present main piece of content as a main feature. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Feature card block &mdash; medium](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/feature-card-block) | The Feature card block — medium pattern is used to present a group of information with a medium size card with an image. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Lead space](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/leadspace)      | The Lead space pattern is used to orient the user when they land on a page and to help them decide whether to continue reading or not as well as orient themselves. It will always be positioned at the top of a web page. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Lead space &mdash; block](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/lead-space-block) | The Lead space &mdash; block is an alternative to the Lead space, enabling a more productive first site of viewer engagement. The Lead space &mdash; block is positioned at the top of a web page, with a purpose to orient the user when they land on a page, inform them of the content, and guide them to the first key piece of content on the page, whether it’s a crucial piece of information or a call-to-action button. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| [Logo grid](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/logo-grid-rich) | The Logo grid pattern is used to present a group of client or partner logos. Currently the logos are not clickable. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
