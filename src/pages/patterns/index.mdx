...
Layout patterns show the many ways in which content can be arranged using the 2x grid. They are used to render prescribed content types in different ways, in response to user needs. Layout patterns form the page structure and user flow in a practical, intuitive and visually pleasing manner.
