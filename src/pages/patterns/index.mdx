...
![Lead space left-aligned](../../images/pattern/leadspace/overview/)
...
![Lead space left-aligned](../../images/pattern/leadspace/overview/patterns-overview_content-hierarchy.png)
...
2. Paragraphs are set at the smallest type size and can accommodate details to support the overall narrative.
3. A card placed at the bottom of this content block signifies that there is additional information to be discovered and is used to drive users to that destination. 
