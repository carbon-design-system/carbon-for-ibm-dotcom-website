...
| Name              | Status                                                                                                             |
 | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| Card section     | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Content block     | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Content group     | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Feature card     | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Lead space | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
