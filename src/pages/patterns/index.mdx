...
![Different patterns can use the same 2x grid. When stacked, the result is a consistent rhythm and visual alignment between each pattern.](../../images/pattern/overview/patterns_overview_2xgrid_section1_do.png)
...
<Caption>This content block with media pattern shows how various elements can be designed and organized based on their priority and relevance. In this example, type scale, image size, negative space, and component usage all play an important role in defining the content hierarchy.</Caption>
...
<Caption>This content group pattern demonstrates how typography of different scales, weight and color can be used to create visual hierarchy.</Caption>
