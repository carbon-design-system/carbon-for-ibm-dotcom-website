...
Layout patterns show the many ways in which content can be arranged using the 2x grid. They are used to communicate prescribed content types and are expressions of IBM's distinct brand ethos. Layout patterns form the overall page structure and serve user needs in a practical, intuitive and visually pleasing manner.
