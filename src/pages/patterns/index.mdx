...
| [Content block &mdash; segmented](https://www.ibm.com/standards/web/ibm-dotcom-library/patterns/content-block-segmented)      | Content block – segmented is a variation of Content block simple with the added ability to add subsections. | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
