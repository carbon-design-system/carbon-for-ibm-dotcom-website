...
| Lead space block | A lead space is positioned at the top of a web page and serves as the first site of viewer engagement.[Design specs](https://ibm.box.com/s/kisml8o6mgrexlvqaa3cv20z1e32sbli) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/patterns-blocks-leadspaceblock--default) | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
