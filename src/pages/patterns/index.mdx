...
![Grouping and spacing](../../images/pattern/overview/patterns_overview_Contrast_section2.png)
...
![The lead space pattern shows how the use of scale and juxtaposition of type and image can be used to emphasize messaging and create clear calls-to-action. ](../../images/pattern/overview/patterns_overview_Contrast_section2.png)
...
![These cards – with images pattern utilizes asymmetry to arrange essential content in a single area. ](../../images/pattern/overview/patterns_overview_Contrast_section3.png)
