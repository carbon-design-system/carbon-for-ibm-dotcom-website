...
| ------------- | -----------   | ----- |
| Callout &mdash; quote      | The Callout — quote is a typographic pattern that is used to highlight an impactful client statement or user testimonial.<br/><br/>[Design specs](https://ibm.box.com/s/5p4zb97inftv5bj6dabgk8cpp9fbdr4w) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-calloutquote--default)| <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Callout &mdash; with media      | The Callout &mdash; with media pattern is used to feature a high value media asset such as a customer story. <br/><br/>[Design specs](https://ibm.box.com/s/40njlbssuzazldqxcvza8pfmlgdva15y) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-calloutwithmedia--default) | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Card section &mdash; with images | The Card section — with images pattern is a collection of card components with images that, together, occupy a full-width section with a left-column header. This pattern is typically used for presenting resources or links. <br/><br/>[Design specs](https://ibm.box.com/s/u4acyo9oeqya8xidimxtidh8k8y08fza) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-cardsectionimages--default)| <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Card section &mdash; simple      | The Card section — simple pattern is a collection of text-based cards presented in a full-width section with a left-column header. This pattern is typically used for presenting resources or links.<br/><br/>[Design specs](https://ibm.box.com/s/6prfrgt7dftdg47ejy3q3m4x7h47kbmo) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-cardsectionsimple--default) | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Content block &mdash; with cards      | The Content block – with cards pattern is used to present small self-contained pieces of information as cards.<br/><br/>[Design specs](https://ibm.box.com/s/9pweudf9ptucx8jxzgo3e2m5jpyke5qi) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-contentblockcards--default) | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Content block &mdash; with media      | The Content block – with media pattern is used to present information with images in a group setting. <br/><br/>[Design specs](https://ibm.box.com/s/9cu22l7vs1dpjy8g8yi3mtoswazqgq2r) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-contentblockmedia--default) | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Content block &mdash; segmented      | The Content block – segmented pattern is a variation of the Content block simple pattern with the added ability to add subsections.<br/><br/>[Design specs](https://ibm.box.com/s/pkascpokk7ae4t3ixis98hmw4e5y1v56) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-contentblocksegmented--default)| <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Content block &mdash; simple      | The Content block — simple pattern is typically used for the introductory section on a page.<br/><br/>[Design specs](https://ibm.box.com/s/7f8mb1xyqdu5pimx9k1xtpl7oqrme0qf) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-contentblocksimple--default) | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Content group &mdash; with cards      | The Content group — with cards pattern is used to present information through a group of cards with each acting as a call to action that drives to additional or supporting destinations. This pattern is suitable for adding concise buckets of content and links to a long-form reading experience.<br/><br/>[Design specs](https://ibm.box.com/s/709822ny79gfn2s3b68noeg1gd14s6zk) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-contentgroupcards--default)  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Content group &mdash; horizontal | The Content group – horizontal pattern is to present a group of relatively more important pieces of content such as products or solutions with more visual weight.<br/><br/>[Design specs](https://ibm.box.com/s/rv5kmm0a4d9ded74v6yfk8ad5id5ghmx)	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-contentgrouphorizontal--default)  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Content group &mdash; with pictograms | The Content group — with pictograms pattern is to present a group of information, each with a supporting pictogram.<br/><br/>[Design specs](https://ibm.box.com/s/af11r4k5fv1wclv1yrl9aic5c68x29ra) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-contentgrouppictograms--default)| <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Content group &mdash; simple | The Content group — simple pattern is an alternative form of a narrative pattern where the content is broken up into smaller pieces to make it more digestible.<br/><br/>[Design specs](https://ibm.box.com/s/einladcnn9zrfbmd0asuoywppr9zx7j9) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-contentgroupsimple--default)  | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| CTA Section      | The CTA section pattern is used to communicate actions that users can take along with some information that is relevant to the actions. <br/><br/> [Design specs](https://ibm.box.com/s/yz1uixuxjf7lge5yvrup3yb3owj70071) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-ctasection--default)| <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Feature card block &mdash; large | The Feature card block — large pattern is used to present main piece of content as a main feature.<br/><br/>[Design specs](https://ibm.box.com/s/fort8v1pj93z0ax6zgipcu0mbxsuwry1) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-featurecardblocklarge--default)| <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Feature card block &mdash; medium | The Feature card block — medium pattern is used to present a group of information with a medium size card with an image.<br/><br/>[Design specs](https://ibm.box.com/s/pasipprq3njaholcg9bgtnv7khzq4kkq) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-featurecardblockmedium--default) | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Lead space      | The Lead space pattern is used to orient the user when they land on a page and to help them decide whether to continue reading or not as well as orient themselves. It will always be positioned at the top of a web page.<br/><br/>[Design specs](https://ibm.box.com/s/d9jey3rlfxqmxu059f0x9dtcx7f5ehuh) 	&#124; [Guideline](https://ibm-dotcom-library.mybluemix.net/patterns/leadspace)| <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Lead space &mdash; block | The Lead space &mdash; block is an alternative to the Lead space, enabling a more productive first site of viewer engagement. The Lead space &mdash; block is positioned at the top of a web page, with a purpose to orient the user when they land on a page, inform them of the content, and guide them to the first key piece of content on the page, whether it’s a crucial piece of information or a call-to-action button.<br/><br/>[Design specs](https://ibm.box.com/s/kisml8o6mgrexlvqaa3cv20z1e32sbli) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-leadspaceblock--default) | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
| Logo grid &mdash; rich | The Logo grid – rich pattern is used to present a group of client or partner logos. Currently the logos are not clickable.<br/><br/>[Design specs](https://ibm.box.com/s/2c2dt2fivbmbcce29oul7hjaktjaqj26) 	&#124; [Storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-logogrid--default)| <span class="bx--tag bx--tag--green"><pre>Stable</pre></span> |
