...
<ExpressiveListContainer
  ...
  text="The [IBM Design Language](https://www.ibm.com/design/language/) provides the guidance and assets used to express the IBM brand in products, communications, marketing, events and digital experiences. Carbon for IBM.com looks to the Design Language for the grid best practices, pictogram, and icons.">
</ExpressiveListContainer>
...
<ExpressiveListContainer
  title="IBM Design Language"
  text="The [IBM Web Standards](https://www.ibm.com/standards/web/) ensure design excellence, along wth technical and legal compliance. It is extremely important that teams follow the governance and adhere to the standards. _IBMer access only_.">
</ExpressiveListContainer>
