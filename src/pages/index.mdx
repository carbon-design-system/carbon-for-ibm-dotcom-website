...
import { Bee, DevicePairing, DesignAndDevelopment } from '@carbon/pictograms-react';
...
<Row className="square-card-group">
  ...
  <SquareCard
    ...
    >
    <DesignAndDevelopment style={{ color: '#007d79'}} aria-label="DesignAndDevelopment" className="my-custom-class" />
  </SquareCard>
