...
<div className="expressive-content-list-group">
  <ExpressiveList
    ...
    background="false">
    The [IBM Design Language](https://www.ibm.com/design/language/) provides the guidance and assets used to express the IBM brand in products, communications, marketing, events and digital experiences. Carbon for IBM.com looks to the Design Language for the grid best practices, pictogram, and icons.
...
<ExpressiveList
  ...
  background="false">
  The [Carbon Design System](https://carbondesignsystem.com/) is IBM's open source design system for products and digital experiences. Carbon for IBM.com depends on Carbon Design System’s elements packages like type, color, and spacing tokens, along with the core components.
  ...
  <ExpressiveList
    ...
    background="false">
    The [IBM Web Standards](https://www.ibm.com/standards/web/) ensure design excellence, along wth technical and legal compliance. It is extremely important that teams follow the governance and adhere to the standards.
    *IBMer access only*.
