...
Beta version of v2 is planned for end of June 2023. This will be the first pre-release version of the library. It will be the first opportunity for adopters/users to work with the package and provide feedback to the team regarding any bugs or differences that weren’t expected. See [Long Term Support](https://github.com/carbon-design-system/carbon-for-ibm-dotcom-website/pull/1573/files) for the timeline.

#### When are we launching Carbon for IBM.com v2 production?

Production release is planned for end of September 2023. This will be when the package is considered General Availability (GA). See [Long Term Support](https://github.com/carbon-design-system/carbon-for-ibm-dotcom-website/pull/1573/files) for the timeline.
