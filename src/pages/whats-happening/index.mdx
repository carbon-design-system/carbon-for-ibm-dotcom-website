...
Carbon for IBM.com v2 will no longer support React and focus fully on web components. This applies to the [@carbon/web-components](https://github.com/carbon-design-system/carbon/tree/main/packages/web-components) package. `@carbon/ibmdotcom-web-components` will still provide React wrappers for projects requiring React.
