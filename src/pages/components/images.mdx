---
title: Images
description: The image wrapper is used to display imagery on the page.
---
...
There are two image components available. The Image component allows for a simple image on a page. The other, Image with caption, offers the addition of a caption and zoom. 
...
| Element                | Content type | Required | Instances | Recommended character <br/>count (English) | Recommended character <br/>count (translated) | Notes/Options |
| ---------------------- | ---------- | -------- | ---------- | ---------------------- | -------------------------|----------------------------------------- |
