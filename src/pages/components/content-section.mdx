...
<Caption>
  See how Content section, Content block, Content group and Content item act as hierarchical content containers for each
  other.{' '}
</Caption>
...
<Caption>Content section with a Content block simple, at desktop and mobile breakpoints</Caption>
...
<Caption>Showcasing the versatility and adaptability of the Content section component</Caption>
