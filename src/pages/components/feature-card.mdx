...
Feature card has two sizes. The default is medium, and consists of an image, heading, and CTA (call-to-action).
...
Feature card -- large allows additional texts (eyebrow and copy) and occupies 12 columns of the page.
