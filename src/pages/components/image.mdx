...
Image at its core is a wrapper that adds an image to the page. You can pass multiple images to a particular image component to render a different image at various breakpoints - this is useful if you need to render different images at different screensizes. 
