...
| ----------------------------------------------------------------------- | ------------- | -------- | --------- | ------------------------------------------- | ------------------------|
| [Card](https://www.ibm.com/standards/carbon/components/cards#card)      | Component     | Yes      | Min 2     |                                             | Card group offset max 1 offset card offset, default 0 |
| [Card in card](https://www.ibm.com/standards/carbon/components/cards#card-in-card)| Component     | No       | 1         |                                   | 1 card in card above rec max 6 in 3:X layout         |
| CTA card                                                                | Component     | No       | 1         |    25/35                                    |                         |
