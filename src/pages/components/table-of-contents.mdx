...
Table of contents labels and the page headings they link to should be the same or a shortened version of the headline. The default or vertical ToC can accommodate multi-line labels, and therefore can generally match the section headline.

#### Examples

| ToC orientation | ToC label                          | Page heading                       |
| --------------- | ---------------------------------- | ---------------------------------- |
| Horizontal      | Overview                           | Overview                           |
| Horizontal      | Connect                            | Connect with IBM                   |
| Vertical        | Connect with IBM                   | Connect with IBM                   |
| Vertical        | Why IT infrastructure is imporatnt | Why IT infrastructure is imporatnt |
