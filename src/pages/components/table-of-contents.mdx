...
Table of contents labels and the section headlines they link to should be the same or a shortened version of the headline. The default or vertical ToC can accommodate multi-line labels, and therefore can generally match the section headline.
