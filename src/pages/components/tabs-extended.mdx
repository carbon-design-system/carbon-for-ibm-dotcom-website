...
Tabs orientation on desktop can be set to horizontal or vertical. When using vertical, the tabs are displayed stacked in 1 column. This orientation allows for longer tab labels.
