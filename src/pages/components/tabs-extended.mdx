...
Tabs extended can nest other components inside its content area to display them in sequence. We recommend nesting similar components in sequence, rather than varying the types of components displayed in a given tabs experience.
