...
<CardGroup>
  <MiniCard
    title="Tabs extended design spec"
    href="https://ibm.ent.box.com/folder/133802998765?s=26zrugvym00408zhpp23gqwnudzmgdd1"
  />
  <MiniCard
    title="Tabs extended functional spec"
    href="https://github.com/carbon-design-system/carbon-for-ibm-dotcom-website/wiki/Tabs-extended"
  />
</CardGroup>
...
For more on Tabs extended using media, see the [functional specs](https://github.com/carbon-design-system/carbon-for-ibm-dotcom-website/wiki/Tabs-extended-media) and [Web Components Storybook](https://www.ibm.com/standards/carbon/web-components/?path=/story/components-tabs-extended-with-media--default).
