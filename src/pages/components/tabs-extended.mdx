...
Tabs extended media is a variation that constructs its content using [Content item horizontal](/components/content-item-horizontal) with media to create an organized section optimized for content with media. This is useful especially when reducing page length is desired. Keep in mind some content will be hidden until user interaction, so they should not be critical information. 

For more on Tabs extended media, you can view the [functional specs](https://github.com/carbon-design-system/carbon-for-ibm-dotcom-website/wiki/Tabs-extended-media) and [Web Components Storybook](https://www.ibm.com/standards/carbon/web-components/?path=/story/components-tabs-extended-with-media--default).
