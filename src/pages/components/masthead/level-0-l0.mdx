...
The standard menu pattern offers additional variations that allow for a unique content item to be featured.

A promotional card **[4]** places the feature item within the rightmost column of the open menu. Either an image or text card may be used. Both types allow an eyebrow, title and link. The image card variation includes a 2:1 image asset. The text card variation allows for descriptive body copy and one or more static tags.

A promotional banner **[5]** sits at the bottom of the open menu and includes a 3-column image area and associated card. The height of the visual banner is determined by the amount of content in the card. The card may include an eyebrow, title and link. If the promotional banner is used, it should not be used in conjunction with the “view all” link zone.
...
The tabbed menu pattern offers additional variations that allow for a unique content item to be featured. Because these promotional elements sit within a specific tab, they should be relevant to that particular segment of content. Do not repeat the same promotional element across all tabs. It is also recommended to select one of the following variations to use underneath a parent navigation label and not to switch between styles across a set of tabs.

A promotional card **[4]** places the feature item within the rightmost column of the open menu. Either an image or text card may be used. Both types allow an eyebrow, title and link. The image card variation includes a 2:1 image asset. The text card variation allows for descriptive body copy and one or more static tags.

A promotional banner **[5]** sits at the bottom of the open menu and includes a 3-column image area and associated card. The height of the visual banner is determined by the amount of content in the card. The card may include an eyebrow, title and link. If the promotional banner is used, it should not be used in conjunction with the “view all” link zone in the tab area.

## Behavior

**Menu overflow**

At the large breakpoint and all wider breakpoints, the L0 masthead will truncate the set of navigation labels when their collective character lengths are wider that the available width of their display container. Initially, a right-facing carat will appear with a subtle gradient, indicating to the user that they can interact with this element to display the overflow menu items. As the user scrolls these items into view, a carat will be mirrored at the left side of the navigation label area, allowing the user to control which labels are in view.
