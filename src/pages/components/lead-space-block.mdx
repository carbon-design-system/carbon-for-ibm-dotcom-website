...
![Lead space block with heding, subheading, video, link list, button, and bottom border](../../images/component/lead-space-block/lead-space-block-overview.png)
...
4. **Link list:** Optional [link list](../components/link-list) to display multiple links leading to related resources.
5. **CTA:** Optional CTA to lead the user to additional resources.
6. **Bottom border:** Optional border to help separate the lead space block from the next [content section](../components/content-section) or [content block](../components/content-block).
