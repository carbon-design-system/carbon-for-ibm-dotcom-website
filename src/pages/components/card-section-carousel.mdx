...
description: Card section – carousel is a collection of cards presented within a carousel with a left-column header that responds to the grid, allowing users to browse multiple pieces of content within the same area of the page.
---
...
Card section – carousel is a collection of cards presented within a carousel with a left-column header that responds to the grid, allowing users to browse multiple pieces of content within the same area of the page.
...
The design specs and functional specs for Card section – carousel can be viewed <a href="https://ibm.box.com/s/hmni7qhero9mf5rn593zij0tcay8h9dw" target="_blank">here</a>.

## Development documentation

<ComponentStatus name="Card section - carousel" type="layout" />
