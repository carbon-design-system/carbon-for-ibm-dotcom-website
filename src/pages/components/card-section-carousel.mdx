...
5. **Controls**: Icon buttons and pagination provide navigational controls for browsing through the carousel. These are required in the Carousel component, and you can learn more about the Carousel [here](https://www.ibm.com/standards/web/carbon-for-ibm-dotcom/components/carousel).
