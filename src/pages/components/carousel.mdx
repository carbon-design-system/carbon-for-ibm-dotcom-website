...
4. **Cards**: The main content of the carousel lives in the cards. This card can be designed with any variations of the [Card component](https://www.ibm.com/standards/web/carbon-for-ibm-dotcom/components/card).
...
* Include 5 or fewer content frames in the carousel.
