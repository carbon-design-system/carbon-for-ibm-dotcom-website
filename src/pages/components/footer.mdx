...
## Minimal Footer
![Image of default footer](../../images/component/footer/Footer_Demo_Minimal.jpg)
...
|               | Default footer is automatically generated based on the country and language code that you set on your page in the metadata|
| Minimal       | Minimal footer variant reduces space by removing any additional navigation           |
