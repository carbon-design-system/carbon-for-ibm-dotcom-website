...
The footer is a required component on all IBM.com pages, there are three sizes available: [default](#default), [short](#short) and [micro](#micro), and each size has a specific usecase. The footer includes the IBM logo, navigational links, locale selector and required legal links.
...
The [language selector](https://www.ibm.com/standards/carbon/components/language-selector) displays only the language of a given page. It uses a combo box, and allows the user to select a language from the list or type in theeir desired language.
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | -------- | --------- | ------------------------------------------- | --------------------------------------------------------------- |
| Logo                                                                                                                                                                      | Image        | Yes      | 1         | –                                           | Required, should not be altered, links to IBM homepage.         |
...
| Adjunct legal links                                                                                                                                                       | Text         | No       | 2         | 20 / 32                                     | Optional legal content that appears below required legal links. |
