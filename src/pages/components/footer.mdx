...
| ------------- | -----------   | ------------------------------------------------------------------------             |
| React         | <span class="bx--tag bx--tag--green"><pre>Stable</pre></span>        | [View sandbox](https://ibmdotcom-react.netlify.com/?path=/story/footer--default)     |
| Vanilla       | <span class="bx--tag bx--tag--purple"><pre>Coming soon</pre></span> | [View sandbox](https://ibmdotcom-vanilla.netlify.com/?path=/story/footer--default) |
