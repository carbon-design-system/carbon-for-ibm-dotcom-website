...
## Micro Footer
This version shows only the legal links, which are required, and theoptional locale selector to maximize the space for the content of the given page. This footer is reserved for stand-alone experiences such as product demos, or slide shows. All other pages and experiences on IBM.com should use the default or the minimal versions.

_This version is still in development._

![Image of minimal footer](../../images/component/footer/Footer_Demo_Micro.jpg)
