...
| ------------- | -----------   | ------------------------------------------------------------------------             |
| React         | <div><span class="bx--tag bx--tag--green"><pre>Stable</pre></span></div>        | [View sandbox](https://ibmdotcom-react.mybluemix.net/?path=/story/footer--default)     |
| Vanilla       | <div><span class="bx--tag bx--tag--green"><pre>Stable</pre></span></div>  | [View sandbox](https://ibmdotcom-vanilla.mybluemix.net/?path=/story/footer--default)   |
