...
| ------------- | -----------   | --- | ------------------------------------------------------------------------             |
| React         | <div><span class="bx--tag bx--tag--green"><pre>Stable</pre></span></div>        | <a href="" target="_blank">Dev docs</a> | [View storybook](https://ibmdotcom-react.mybluemix.net/?path=/story/components-footer--default)     |
