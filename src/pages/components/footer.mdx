...
The Footer is a required component on all IBM.com pages. There are three sizes available: [Default](#default), [Short](#short) and [Micro](#micro), and each size has a specific use case. The Footer includes the IBM logo, navigational links, locale or language selector and required legal links.
...
4. **Adjunct legal link(s) (optional)**: Use up to two adjunct legal links for notes or messages legally required to provide regarding changes, policies or trademark issues.
...
1. **IBM logo:** TBD
2. **Legal links:** The general legal links are present on every IBM Footer and cannot be changed.
