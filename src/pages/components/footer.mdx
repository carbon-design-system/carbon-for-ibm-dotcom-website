...
| Vanilla       | <div>class="bx--tag bx--tag--cool-gray"><pre>Under construction</pre></span></div>  | [View storybook](https://ibmdotcom-vanilla.mybluemix.net/?path=/story/components-footer--default)   |
