...
![Image of Card anatomy](../../images/component/card/card-default.png)
...
Cards featuring a pictogram must have a heading, and optionally can include body copy. Cards with pictograms offer two pictogram alignments: top-aligned or bottom-aligned.
...
![Example of cards with static modifier, in which they lack a border](../../images/component/card/card-static.png)
