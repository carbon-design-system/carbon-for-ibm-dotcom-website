...
![Image of Card components - Card, Card in card, Feature card, and pictogram card](../../images/component/card/cards-dual-abstract-1120-2.jpg)
<Caption>From top to bottom: Card, Card in card, Card link, and Feature card.</Caption>
...
4. **CTA type:** When using an icon, by default will use `ArrowRight`.
...
3. **Body copy (optional):** Optional body copy can be added for additional descriptions.
4. **CTA type:** When using an icon, by default will use `ArrowRight`.
