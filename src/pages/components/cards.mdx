---
title: Cards
description: Card is a workhorse component which presents content in a concise and readable style.
---
...
3. **CTA type:** When using an icon, by default will use `ArrowRight`.
...
5. **CTA type:** When using an icon, by default will use `ArrowRight`.
