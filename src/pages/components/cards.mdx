...
<Caption>
  Examples of card with a pictogram top-aligned and bottom-aligned
</Caption>
...
Static card can support a text link, however, we highly encourage teams to utilize the [content item](../components/content-item) component instead of static cards to ensure that page variation – we are seeing many pages filled with only cards – and ensure that users do not confuse static cards with actionable cards.
