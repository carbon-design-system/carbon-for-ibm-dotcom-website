...
The logo image itself should be contained inside a space (2:1 aspect ratio). The container size is fixed at all the breakpoints. A logo grid is available in the [design specifications](https://ibm.ent.box.com/folder/95514001950?s=qqw0soczjpawvuh9j3x19fmcoqk1zsw7).
The logo is best displayed with either a transparent background or a background color that matches the card background.
