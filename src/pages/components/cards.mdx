...
By default, the entire Card is clickable with a single destination, but by adding the Static modifier you can add multiple links to a single card. This can be useful when you have multiple interactive interactive elements on a single card such as CTAs and Tag links that take the user to different pages. Static cards can appear with or without a border.

<Row>
<Column colMd={8} colLg={8}>

![Example animation of Card with static featuring two different links](../../images/component/card/cards-modifier-card-static-5.gif)

<Caption>Example of a Card with the static modifier that links to one page with the Tag link, and another page with the CTA link.</Caption>
