...
3. **Icon:** By default, uses `ArrowRight`.
...
| [CTA text](https://www.ibm.com/standards/carbon/components/cta)         | Link          | No       | 1         |                                            | Required for cards with CTAs, displays after text (see below)   |
| [CTA icon](https://www.ibm.com/standards/carbon/components/cta)         | Icon          | No       | 1         | 25 / 35                                    | URL assigned in setup  |
