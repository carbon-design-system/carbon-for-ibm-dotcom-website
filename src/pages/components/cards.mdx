---
title: Cards
description: Card is a workhorse component which presenting content in a concise and readable style.
---
...
The Card component is a flexible element that can be used on its own or combined with other components. [Card](#card) can be used to navigate users to information-rich articles. [Card link](#card-link) is presented with other content as a jumping off point for more information. [Card in card](#card-in-card) can put focus on images while using the card to provide more context. [Feature card](#feature-card) can highlight a piece of content on the page, and should be used sparingly.

<Row>
<Column colMd={8} colLg={8}>

![From top to bottom: Card, Card in card, Card link, and Feature card.](../../images/component/card/cards-preview-image.png)
<Caption></Caption>
...
1. **Heading (required):** Heading has the highest information hierarchy on a card, and should be succinct and descriptive.
...
4. **CTA type (required):** When using an icon, by default will use `ArrowRight`.
...
1. **Media (required):** Can be an image or a video.
2. **Heading (required):** Heading has the highest information hierarchy on a card, and should be succinct and descriptive.
3. **Body copy:** Optional body copy can be added for additional descriptions.
4. **CTA type (required):** When using an icon, by default will use `ArrowRight`.
...
3. **CTA type (required):** When using an icon, by default will use `ArrowRight`.
...
1. **Image (required):** Must use a 1:1 aspect ratio.
3. **Heading (required):** Heading has the highest information hierarchy on a card, and should be succinct and descriptive.
5. **CTA type (required):** When using an icon, by default will use `ArrowRight`.
6. **Type (required):** Determines the size of the Feature card.
...
5. **CTA type (required):** When using an icon, by default will use `ArrowRight`.
6. **Type:** Determines the size of the Feature card.
