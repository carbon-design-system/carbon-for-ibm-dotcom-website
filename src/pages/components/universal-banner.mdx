...
![A visual example of universal banner](../../images/component/universal-banner/universal-banner--overview--060122.png)

<Caption>Example of universal banner</Caption>

### Anatomy

![A visual example of the universal banner anatomy](../../images/component/universal-banner/universal-banner--anatomy--060122.png)
...
![A visual example of universal banner with text only](../../images/component/universal-banner/universal-banner--with-text-only--060122.png)
...
When an image is added to Universal banner, the image frame will resize based on the window size. For more information on planning for the image asset, view the [design specs](https://ibm.ent.box.com/folder/142303458357).

![A visual example of universal banner with image](../../images/component/universal-banner/universal-banner--with-image--060122.png)
...
The Universal banner adapts its visuals and interactions on `sm` and `md` breakpoints. The key changes are:
...
![A visual example of the universal banner at the small breakpoint](../../images/component/universal-banner/universal-banner--behaviors--060122.png)
