...
| -------- | --------- | ---------- | ---------- | ----------|
| Headline (caption) | Short copy | Yes | 1 | XXS (40 / 55)|
| Description | Long copy | No | 1 | L (150 / 200)|
| Image | Media | Yes | 1 | - |
| [Lightbox media viewer](https://www.ibm.com/standards/web/carbon-for-ibm-dotcom/components/lightbox-media-viewer) | Component | No | 1 | If enabled, the user can view the image and description in the lightbox modal by selecting the image. |
