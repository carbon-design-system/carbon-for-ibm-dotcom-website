...
In this example the content section is paired with a group of [content item pictograms](./content-item) that span the center 8 columns of the grid.
...
In this example the content section is paired with a [card group](./card-group) that spans 12 columns of the grid.
