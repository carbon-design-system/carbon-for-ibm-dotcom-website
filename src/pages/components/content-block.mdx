...
1. **Content block heading:** An optional, customizable heading.
2. **Sub heading:** An optional, customizable sub heading.
...
Similar to the content block, the content block can accept child components which allows designers and authors maximum flexibility when creating page layouts. The most common layouts on IBM.com are 8 column and 12 column components.
...
<Caption>
  Content block with a heading and a card group child spanning 12 columns
</Caption>
...
At smaller breakpoints the content block will respond to the 2x grid.
