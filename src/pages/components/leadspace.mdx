...
| [Button group](https://www.ibm.com/standards/carbon/components/button-group) | Component  | No       | XXS (40 / 55)                                  | Lead space Short (320px) does not allow a button group or a short copy. |
...
| [Button group](https://www.ibm.com/standards/carbon/components/button-group) | Component   | No       | Max of two buttons | XXS (40 / 55)                                  | –                                                      |
| Gradient                                                                                        | True/False  | No       | –                  | –                                              | True – Show gradient (default)<br/>False – No gradient |
