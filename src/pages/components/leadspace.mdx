...
All Lead space variants have the option to include Tag links or breadcrumbs to aid in wayfinding.

#### Tag links

A collection of [Tag links](https://www.ibm.com/standards/carbon/components/tag-link) can be added to the Lead space, and always appear above the headline to establish context. Tag links work well in cases where the navigation does not have a clear, linear hierarchy.
...
All Lead space variants have the option to include a background image or video to create visual interest from the first moment in an experience. In both cases, a gradient will appear in front of the media so that the Lead space copy can be accessible.

#### Background image

An image can be used in the Lead space to draw attention to the first content on the page. On the tablet and mobile, the image will appear below the heading, body copy, and button group. When creating imagery for the lead space, keep the focus of the image on the area that appears without the gradient.

![Lead space with video](../../images/component/lead-space/component--lead-space--super--background-image.jpg)

<Caption>Lead space super with background image</Caption>
