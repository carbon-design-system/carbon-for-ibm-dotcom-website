...
There are five variants split into two types, each designed for specific situations. Four size variants are available for left-aligned lead spaces, and a fifth variant exists for center-aligned lead spaces. [See the table below](#content-guidance).
