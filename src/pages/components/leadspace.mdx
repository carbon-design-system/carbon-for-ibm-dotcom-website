...
<Caption>Example: Lead space – Tall – 560px height at max 1584px breakpoint, with $expressive-heading-06 heading</Caption>
...
### Dark themes (black, gray 100 or gray 90)

Use `black`, `gray 100` or `gray 90` when the background image has shadows, is dimly lit, or uses a dark color palette.
