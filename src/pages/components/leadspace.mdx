...
| [Medium](#medium)  |  Close related to Tall, this variation can be used for pre-purchase and post-purchase stages, like the navigation pages. |
| [Short](#short)   |  It is a more efficient variant. It is mostly used in the purchase stage, for registration, configuration and checkout experiences. |
| [Centered](#centered)   |  This is a special variantion that can be used for learning pages, long-form reading experiences, and use cases. |
