...
![Lead space variants](../../images/component/lead-space/component--lead-space--overview.jpg)
...
1. **Background media** Optional component that adds a background image or video and a gradient for accessibility.

### Behaviors

It is worth noting that on the mobile breakpoint small, **for all the lead space components detailed on this page**, the background media component sends the background image as inline image and positions it last, after the button group, as seen below.
