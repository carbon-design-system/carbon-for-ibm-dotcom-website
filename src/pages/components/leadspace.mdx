...
| [Centered](#centered) | This is a special variant that can be used for learning pages, long-form reading experiences, and use cases. When center-aligning content, the height varies based on the content.                                                                          |
