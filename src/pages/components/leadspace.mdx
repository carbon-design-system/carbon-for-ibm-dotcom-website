...
A lead space is positioned at the top of a web page and serves as one of the most efficient and powerful communication tools. Its primary purpose is to orient the user and quickly inform them of the page content. There are five variants, designed for specific situations.  [Super](#super) is the most prominent variant. It is used at the start of a user's journey, for homepages and landing pages. [Tall](#tall) and [Medium](#medium) are Lead space variants that follow the users throughout their pre-purchase or post-purchase journey, and [Short](#short) is a more efficient and precise type of lead space, for users that are engaged in the purchase stages of their journey. [Centered](#centered) lead space can be a powerful tool for long-form reading experiences.
...
| [Medium](#medium)  |  Close related to Tall, this variant can be used for pre-purchase and post-purchase stage, and it is generally a safe choice, because it captures attention while still allows a lot of content above the fold. |
...
Tall is a left-aligned lead space variant mostly used in the pre-purchase stages of the buying cycle, like the learning stage. It can communicate a message very clearly with its semibold, big type heading. It has a 560px fixed height for the desktop experience, and it is variable in height for smaller screens.
...
Short is an efficient and precise left-aligned lead space variant mostly used in the purchase stages of the buying cycle. Short can also be used to lead additional info following a landing page, for example the product pricing page. It has a 320px fixed height for the desktop experience, and it is variable in height for smaller screens. 
...
| Button group                                                    | Component    | No       | 1         | 40 / 55                                     | Lead space Short variant (320px height) does not allow a button group under the heading    |
