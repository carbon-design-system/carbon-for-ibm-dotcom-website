...
| [Medium](#medium)     | Closely related to Tall, this variant can be used for the pre-purchase and post-purchase stage in the user journey. It captures attention while allowing a more content in the lead space. _Available for left-aligned content_. |
