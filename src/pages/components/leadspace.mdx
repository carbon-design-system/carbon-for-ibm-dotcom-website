...
A collection of [tags](https://www.ibm.com/standards/carbon/components/tags) can be added to the lead space, and always appear above the headline to establish context. Tags are not interactive, and instead provide more context to the lead space by categorizing or "tagging" content. Tags work well in cases where the navigation does not have a clear, linear hierarchy. We recommend using more than one tag to represent a polyhierarchical structure.
