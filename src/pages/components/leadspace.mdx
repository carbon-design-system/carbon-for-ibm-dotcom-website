...
A lead space is positioned at the top of a web page and serves as one of the most efficient and powerful communication tools. Its primary purpose is to orient the user and quickly inform them of the page content. [Super](#super) is the most prominent variation. It is used at the start of a user's journey, for homepages and landing pages. [Tall](#tall) and [Medium](#medium) are Lead space variations that follow the users throughout their pre-purchase or post-purchase journey, and [Short](#short) is a more efficient and precise type of lead space, for users that are engaged in the purchase stages of their journey. [Centered](#centered) lead space can be a powerful tool for long-form reading experiences.
...
| Lead space variation   | Use cases              | 
| ---------------- | ---------------------- |
| [Super](#super)   |  Used mainly for homepages, landing pages and more expressive marketing experiences |
| [Tall](#tall)     |  This variation is the default lead space. It is more efficient when used for pre-purchase learn pages. |
| [Medium](#medium)  |  Close related to Tall, this variation can be used for pre-purchase and post-purchase stage, and it is generally a safe choice, because it captures attention while still allows a lot of content above the fold. |
| [Short](#short)   |  This is the shortest, yet very efficient variant. It is mostly used in the purchase stage experiences, eg. the product pricing pages, where the users are more focused on the product or service details. |
| [Centered](#centered)   |  This is a special variation that can be used for learning pages, long-form reading experiences, and use cases. |
...
<Caption>
  Tall (560px height), with its prominent semibold heading
</Caption>
...
Medium is a left-aligned lead space component mostly used in the pre-purchase and post-purchase stages of the buying cycle, and it is generally a safe choice, because it captures attention while still allows a lot of content to peek above the fold. Avoid using this height variant if the page is a homepage or you are creating a landing page experience. It has a 480px fixed height for desktop viewports, and it is also variable in height for smaller screens.
...
Short is an efficient and precise left-aligned lead space component mostly used in the purchase stages of the buying cycle. Short can also be used to lead additional info following a landing page, for exampple the product pricing page. It has a 320px fixed height for the desktop experience, and it is variable in height for smaller screens. 
...
On small breakpoint (320px), the background image switches to an inline image and it will be positioned last, after the button group, as seen below.
...
Breadcrumbs can be used above the Lead space heading, replacing the Tag group to cover a wider range of needs and navigational purposes.
...
### Content guidance for Lead space
...
| Copy                                                            | Text         | No       | 1         | 120 / 150                                   | Lead space variation Short (320px height) does not allow copy under the heading    |
| Button group                                                    | Component    | No       | 1         | 40 / 55                                     | Lead space variation Short (320px height) does not allow a button group under the heading    |
| Background media                                                | Component    | No       | 1         | –                                           |     |
| Alt image text                                                  | Text         | No       | 1         | 75 / 100                                    | Image description for accessibility  |
| Alignment                                                  | Option list         | Yes       | –         | –                                  | Center, left, size (for left-aligned only) |
