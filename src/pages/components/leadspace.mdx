...
An image can be used in the Lead space to draw attention to the first content on the page. At the medium and small breakpoints, the image will appear below the heading, body copy, and button group. When creating imagery for the lead space, keep the focus of the image on the area that appears without the gradient.
