...
On small breakpoint (320px), the background image switches to an inline image and is positioned last, after the button group, as shown below.

![Lead space on mobile](../../images/component/lead-space/component--lead-space--super--behaviors.jpg)

<Caption>
  Lead space behavior on desktop (left) and mobile (right)
</Caption>
