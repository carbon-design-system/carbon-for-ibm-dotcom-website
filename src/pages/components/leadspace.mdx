...
| Field                    | Required                                                                                              | Max character size (English / translated) |
| ------------------------ | ----------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| Headline                 | Yes                                                                                                   | XS (65 / 85)                              |
| Short copy               | No                                                                                                    | M (120 / 150)                             |
| Secondary call to action | No                                                                                                    | M (120 / 150)                             |
| Primary call to action   | No                                                                                                    | XXS                                       |
| Background image         | Yes<br/> <br/><div style="max-width: 200px">\_Note: each breakpoint requires a different image.</div> |                                           |
