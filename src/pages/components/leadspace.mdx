...
| [CTA](https://www.ibm.com/standards/carbon/components/cta/#button)      | Component                                                        | No       | 1         | 40 / 55                                     | Button style CTA only. Lead space short variant (320px height) does not allow a button group under the heading. |
