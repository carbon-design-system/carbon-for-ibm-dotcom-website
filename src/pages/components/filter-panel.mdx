...
<Caption>
  From left to right, the small breakpoint screens above demonstrate the following states: no filter applied, filter
  panel open, and filters active.{' '}
</Caption>
...
<Caption>
  Example of Filter panel with seven filter categories, the first two categories open by default, the other five
...
<Caption>
  Example of Filter panel with ten filter categories, the first category open by default, the other nine categories
  collapsed.
</Caption>
...
<Caption>
  Example of a filter category with five filter items exposed, followed by a View all button that will display the
  remaining filter items within the category.
</Caption>
...
<Caption>
  Example of a the filter category with all filter items open after the user selected the View all button.
</Caption>
