...
<ComponentDescription name="CTA block and section" type="layout" />
...
<ResourceLinks name="CTA block and section" type="layout" multiComponent />
...
<ComponentFooter name="CTA block and section" type="layout" />
