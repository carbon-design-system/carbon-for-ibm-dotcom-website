...
The Card section is a section level component that displays a list of Cards with or without images. The left side container includes a section heading, while the right side includes an array of Cards.

## Card section

Card section uses uses cards with a header and body copy to present links to other parts of IBM.com. 
