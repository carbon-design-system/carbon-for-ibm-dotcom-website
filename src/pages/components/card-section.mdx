...
#### Resources
For more information about Card section images, see the following resources. 

<CardGroup>
  <MiniCard
    title="Design specifications for Card section images"
    href="https://ibm.ent.box.com/folder/102045217811?s=u4acyo9oeqya8xidimxtidh8k8y08fza"
  >
    <img src={sketchSymbol} alt="Sketch"/>
  </MiniCard>
  <MiniCard
    title="Functional specifications for Card section images"
