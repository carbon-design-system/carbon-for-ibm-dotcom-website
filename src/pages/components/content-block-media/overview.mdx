...
## Content guidance
The content model below is the default model for the Content block - with media component. <br></br>For content models tied to specific use cases, please select the 'Use cases' tab at the top of the page or see them [here](https://www.ibm.com/standards/web/carbon-for-ibm-dotcom/components/content-block-media/use-cases).
