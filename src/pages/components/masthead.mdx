...
| Primary menu item                                                       |   Text        | Yes      | 6         | 25 / 35                                  | Link to page or opens dropdown menu for label; if link, url assigned in setup; consult IA group on label customization.                                                              | |
