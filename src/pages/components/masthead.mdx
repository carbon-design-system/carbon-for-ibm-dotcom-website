...
| ------------- | -----------   | ------------------------------------------------------------------------             |
| _Default L0_  | `Coming soon` | L0 houses global elements and parent offering content                                |
| _Default L1_  | `Coming soon` | L1 houses local content which is a part of/sub-content of the parent offering        |
