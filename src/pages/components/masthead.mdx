...
As a fundamental component of the IBM.com web experience, the white masthead should remain consistent, creating a branded anchor across all pages that stands out from the dark lead space. This is carefully decided based on its visual impact across majority of the IBM.com pages, where dark lead spaces on white marketing pages are common.

The other reason for masthead to be locked o white theme is that within IBM.com, we do not allow dark and light mode toggling.

In addition to providing brand recognition, a consistent masthead removes variability when building graphic heavy marketing pages, which can cause unexpected results at scale.

For individual use cases, if a color theme change will have a positive impact on the web experience, please contact us.
