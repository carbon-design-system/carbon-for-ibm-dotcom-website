...
_this is a test between two images, one without no padding (above), one with padding (below)
...
_this is a test of two images, following our image specs jpg (above), following Carbon image specs png (below)
