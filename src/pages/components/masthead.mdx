...
Visually the white theme has proven to be safer and more versitile than the dark masthead, which could create a stark band when used in contrast, or blend into a dark lead space. Keeping the global navigation locked, above and "out of the way" allows page makers to explore any theming combinations for rest of the page.

Unlike some products and dashboards, IBM.com web experience do not support dark and light mode switching, which is another reason for keeping masthead white. The majority of IBM.com are marketing pages using expressive imagery, company logos, and different themes across page sections. Dark and light mode switching can cause unexpected results at scale.
