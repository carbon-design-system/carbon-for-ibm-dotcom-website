...
Unlike some products and dashboards, the IBM.com web experience does not support dark and light mode switching. The majority of IBM.com are marketing pages using expressive imagery, company logos, and different themes across page sections. Dark and light mode switching can cause unexpected results at scale, which is another reason for keeping the masthead white.
