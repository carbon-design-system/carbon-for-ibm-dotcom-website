...
| ------------- | -----------   | ------------------------------------------------------------------------             |
| React (Masthead Level 0)        | <div><span class="bx--tag bx--tag--green"><pre>Stable</pre></span></div>        | [View sandbox](https://ibmdotcom-react.mybluemix.net/?path=/story/masthead--default)     |
