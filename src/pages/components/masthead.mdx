...
There is a version of the mega menu with a two column layout that allows content to be highlighted on the left column. Currently it is only being used for the Products & Solutions mega mneu.

![Masthead component level 0 products and solutions image](../../images/component/masthead/masthead-l0-productandsolutions.png)
