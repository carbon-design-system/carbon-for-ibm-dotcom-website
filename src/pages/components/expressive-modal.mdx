...
![Image of Expressive modal used in a login context](../../images/component/expressive-modal/expressive-modal-default--usecase.jpg)
...
Clicking on the close icon x or on the overlay will dismiss the modal.
