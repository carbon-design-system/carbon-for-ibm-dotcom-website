...
![Content item horizontal anatomy](../../images/component/content-item-horizontal/content-item-horiz-anatomy.png)
...
The default version of content item horizontal is the only variation that does not require an image. This variant is ideal for supporting text-only lists or using multiple instances, some with an image and some text only images.

![Content item horizontal default](../../images/component/content-item-horizontal/content-item-horiz-default.png)

<Caption>Example of content item horizontal.</Caption>

<Row>

<Column colMd={4} colLg={4}>

![Example of using text-only](../../images/component/content-item-horizontal/cih-default-1.png)

<Caption>
  Example of using the text only content item horizontal variant in a group.
</Caption>
...
![Example of using an image and text-only](../../images/component/content-item-horizontal/cih-default-2.png)

<Caption>
  Example of using content item horizontal with an image, followed by two
  text-only instances.
</Caption>
...
**Content guidance for content item horizontal**
...
<Caption>Example of content item horizontal with media.</Caption>
...
**Content guidance for content item horizontal with media**
...
![Content item horizontal with media](../../images/component/content-item-horizontal/content-item-horiz-featured.png)

<Caption>Example of content item horizontal with featured media.</Caption>

<div style="padding-top: 24px;"></div>

**Content guidance for content item horizontal with featured media**
...
**Content guidance for content item horizontal with thumbnail**
...
<Caption>
  Example of using different content item horizontal variants in a group to
  emphasize the first item.
</Caption>
