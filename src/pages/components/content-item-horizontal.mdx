...
<Caption>
  Example of content item horizontal.
</Caption>
...
<Caption>
  Example of using content item horizontal with an image, followed by two text-only instances.
</Caption>
...
<Caption>
  Example of content item horizontal with media.
</Caption>
...
![Content item horizontal with media](../../images/component/content-item-horizontal/content-item-horiz-media-featured.png)

<Caption>
  Example of content item horizontal with featured media.
</Caption>
