...
| -------- | --------- | ---------- | ---------- | ----------| 
| [CTA (button)](https://www.carbondesignsystem.com/components/button/usage) | Component | Yes | Two or more buttons | There is one primary button shown at the end. The rest of the buttons are secondary.  |
