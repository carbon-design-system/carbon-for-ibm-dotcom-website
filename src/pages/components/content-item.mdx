...
larger content components such as [content section](../components/content-section) or [content group](../components/content-group) . One of the advantages of the content item is that it is consistent throughout the IBM.com pages. Consider using content item when there is no need for a link.
