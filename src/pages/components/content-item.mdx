...
![Examples of content item with different media: image, pictogram, logo, and percentage](../../images/component/content-item/content-item-media.png)
...
<Caption>
  ...
  right: image, pictogram, logo, and percentage.
</Caption>
