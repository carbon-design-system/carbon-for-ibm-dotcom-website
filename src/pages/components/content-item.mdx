...
Content item has two options for orientation: vertical and horizontal. Note that when appearing a group, each content item should have the same orientation. In addition, certain media add-ons are only available in the vertical orientation (see the media add-on section).

#### Vertical

The vertical orientation places the media add-on above the heading and body copy content across all breakpoints.

Vertical orientation supports the all media add-ons for content item: Image, Pictogram, App icon, Percentage, and Logos.

#### Horizontal

The horizontal orientation places the media add-on side-by-side with the heading and body copy content across larger breakpoints. Note that on the mobile breakpoint, content items that are horizontally aligned will swap to a vertical alignment for better visibility.

Horizontal orientation supports the following media add-ons for content item: Image, Pictogram, and App icon. Percentage and Logo are only available in the vertical orientation.

### Media add-on

Content item can be displayed with a relevant
Pictogram, Logo (vertical only), Image, Percentage (vertical only)
