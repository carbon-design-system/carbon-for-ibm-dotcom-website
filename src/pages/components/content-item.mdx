...
Content item has two options for orientation: vertical and horizontal. Note that when appearing a group, each content item should have the same orientation. In addition, certain media additions are only available in the vertical orientation (see the Media section).
...
Content item can be displayed with a relevant Pictogram, Logo, Image, Percentage to visually enhance the messaging.

#### Pictogram

Pictogram add visually interest to content items that help reinforce understanding about a particular topic. Pictograms excel at representing abstract ideas such as industries, technology, and areas(?).
...
Note that Percentage can only be displayed in a vertically-aligned content item.
