...
| ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Content item row](https://www.ibm.com/standards/carbon/components/content-item-row) | Content item row is a Content item with link list that takes the last 12 grid columns on desktop breakpoints. It does not have the grid flexibility of the Content item component. |
