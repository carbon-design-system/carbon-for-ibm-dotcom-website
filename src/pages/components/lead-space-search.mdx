...
Lead space search includes a heading, a Carbon [search](https://carbondesignsystem.com/components/search/usage/) field, an optional subheading, and an optional background image. This version of the lead space is especially useful when the page displays many options that a user could be interested in.
...
4. **Background media:** Optional media that sits behind the heading and subheading elements.
...
The search component spans 10 columns of the 16 column grid.
...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | -------- | --------- | ------------------------------------------- | ---------------------------------------- |
| Wayfinding              | [Breadcrumbs](https://carbondesignsystem.com/components/breadcrumb/usage/) or [Tags](https://carbondesignsystem.com/components/tag/usage/) | No       | 1         | –                                           | Breadcrumbs or Tag group.                |
