...
Lead space search provides the option to wrap the search field and search field container into an adjacent theme. When enabling the adjacent themes pairs White/Gray10, Gray10/White, Gray90/Gray100 and Gray100/Gray90.
