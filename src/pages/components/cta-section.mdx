...
CTA block is a flexible component that can be configured with a heading, copy, and CTA. CTA section builds on CTA block and adds a content section sub-heading.
...
Both CTA block and CTA section can add a collection of various content items or a link list below the primary CTA.
...
This variation adds a link list below the primary content and is typically used to collect relevant links or resouces for the user.
