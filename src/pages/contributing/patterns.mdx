...
For guidelines about preparing patterns for publication, see the Carbon Design System's [Contributing > Patterns](https://carbondesignsystem.com/contributing/pattern/) page.
