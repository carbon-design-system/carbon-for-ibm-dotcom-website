...
Components for **Carbon for IBM.com** must be built with Web Components. If you need help getting started developing with Web Components, reach out to the engineers in our slack channel for training <a href="https://ibm-studios.slack.com/archives/C2PLX8GQ6" target="_blank">#carbon-for-ibm-dotcom</a>. Please read the [Developer guide](https://github.com/carbon-design-system/carbon-for-ibm-dotcom/blob/main/docs/developing.md) and the [Submissions guidelines](https://github.com/carbon-design-system/carbon-for-ibm-dotcom/blob/main/docs/submission-guidelines.md) for more details.
