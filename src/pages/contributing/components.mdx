...
Our component documentation typically contains five sections: Default, Usage guidance, Design and functional specifications, Development documentation, and Feedback. You can create a new page for your markdown contribution [here](https://github.com/carbon-design-system/carbon-for-ibm-dotcom-website/new/master/src/pages/components). Some components are more complex than others but you should cover each topic included in these markdown templates. 
